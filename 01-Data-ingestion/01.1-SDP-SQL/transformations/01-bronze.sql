...
AS SELECT * FROM cloud_files("/Volumes/demos/dbdemos_retail_c360/c360/events", "csv", map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM cloud_files("/Volumes/demos/dbdemos_retail_c360/c360/orders", "json")
...
AS SELECT * FROM cloud_files("/Volumes/demos/dbdemos_retail_c360/c360/users", "json", map("cloudFiles.inferColumnTypes", "true"))
